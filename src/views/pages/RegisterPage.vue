...
<template>
  <div class="grid min-h-screen xl:grid-cols-2">
    ...
    <div class="mx-auto h-full w-full max-w-2xl p-10">
      <Logo show-name size="big" />
      <div class="mt-10">
        <h2 class="text-4xl font-semibold">Register</h2>
        <h2 class="mt-2 font-light">Create your own account and enjoy the app</h2>
        ...
        <FormItem class="!mt-2">
          ...
          <FormControl>
            <div class="relative flex items-center">
              ...
              <div class="absolute right-3 cursor-pointer" @click="toggleShowConfirmPassword">
                <svg v-if="!isShowConfirmPassword" class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1"
                     viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z"
                    stroke-linecap="round"
